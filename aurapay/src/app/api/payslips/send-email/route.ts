...
export async function POST(req: NextRequest) {
  ...
  try {
    await transporter.sendMail({
      from: `"${clinicName}" <${settings.email_from || settings.smtp_user}>`,
      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
          ...
          <div style="padding:25px;background:#fff;border:1px solid #e9ecef">
            ...
            <p style="font-size:13px;color:#868e96">This payslip was generated by ${clinicName}. If you have questions, please contact the practice manager.</p>
          </div>
