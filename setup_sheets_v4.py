...
def setup_lab_bills_log(spreadsheet):
    """Create Lab Bills Log tab for tracking assigned lab bills"""
    print("Creating Lab Bills Log...")
    
    try:
        old_sheet = spreadsheet.worksheet("Lab Bills Log")
        spreadsheet.del_worksheet(old_sheet)
    except:
        pass
    
    sh = spreadsheet.add_worksheet("Lab Bills Log", 1000, 10)
    apply_base_formatting(spreadsheet, sh)
    ...
    requests = [
        ...
        {'updateDimensionProperties': {'range': {'sheetId': sheet_id, 'dimension': 'COLUMNS', 'startIndex': 2, 'endIndex': 3}, 'properties': {'pixelSize': 100}, 'fields': 'pixelSize'}},
        {'updateDimensionProperties': {'range': {'sheetId': sheet_id, 'dimension': 'COLUMNS', 'startIndex': 3, 'endIndex': 9}, 'properties': {'pixelSize': 120}, 'fields': 'pixelSize'}},
    ...
    spreadsheet.batch_update({'requests': requests})
    sh.freeze(rows=5)
    print("   ✅ Lab Bills Log created")


def setup_unassigned_lab_bills(spreadsheet):
    """Create Unassigned Lab Bills tab for manual assignment"""
    print("Creating Unassigned Lab Bills...")
    
    try:
        old_sheet = spreadsheet.worksheet("Unassigned Lab Bills")
        spreadsheet.del_worksheet(old_sheet)
    except:
        pass
    
    sh = spreadsheet.add_worksheet("Unassigned Lab Bills", 200, 10)
    apply_base_formatting(spreadsheet, sh)
    
    data = [
        [""],
        ["", "UNASSIGNED LAB BILLS", "", "", "", "", "", "", "", ""],
        ["", "Lab bills that need manual dentist assignment", "", "", "", "", "", "", "", ""],
        [""],
    ...
    requests = [
        ...
        {'repeatCell': {'range': {'sheetId': sheet_id, 'startRowIndex': 1, 'endRowIndex': 2, 'startColumnIndex': 1, 'endColumnIndex': 6},
            'cell': {'userEnteredFormat': {'textFormat': {'foregroundColor': COLORS['warning_text'], 'bold': True, 'fontSize': 14}}}, 'fields': 'userEnteredFormat.textFormat'}},
        {'repeatCell': {'range': {'sheetId': sheet_id, 'startRowIndex': 4, 'endRowIndex': 5, 'startColumnIndex': 1, 'endColumnIndex': 9},
            'cell': {'userEnteredFormat': {'backgroundColor': COLORS['warning'], 'textFormat': {'bold': True, 'foregroundColor': COLORS['warning_text']},
                'borders': {'bottom': {'style': 'SOLID', 'width': 2, 'color': COLORS['warning_text']}}}},
            'fields': 'userEnteredFormat.backgroundColor,userEnteredFormat.textFormat,userEnteredFormat.borders'}},
    ]
    spreadsheet.batch_update({'requests': requests})
    sh.freeze(rows=5)
...
def main():
    """Main setup function"""
    print("=" * 60)
    print("🦷 AURA DENTAL - PROFESSIONAL SHEET SETUP v4.0")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print("✅ PROFESSIONAL SETUP v4.0 COMPLETE!")
    print("=" * 60)
